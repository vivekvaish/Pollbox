...
<h1> Create your poll</h1>       
       ...
       <table>
		<tr>
		 ...
		 <tr>
            <td><b>Expiry Date:</b></td><td><input name="poll_expiry_date" type="text" id="poll_expiry_date" class="input-xlarge" size="12" readonly="readonly" /> </td>
         </tr>
         <tr><td><br /></td></tr>
		 <tr>
		 ...
		 <tr><td><br /></td></tr>
		  ...
		  <tr><td><br /></td></tr>
          <tr><td><b> Upload Options: </b><input type="hidden" name="options_type" id="options_type" class="input-xlarge" value="text"><input type="hidden" name="total_op" id="total_option" value="2"></td><td></td></tr>
		...
		if ( validate_op() && validate() && validate_title() && validate_des()== 1)
	{
		...
		var obj = {who : "776537974", expiry_date : document.getElementById('poll_expiry_date').value,visibility : "public",
