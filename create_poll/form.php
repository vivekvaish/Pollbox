	    ...
	    <div class="container">
          ...
          <div class="nav-collapse">
			...
			<li class="active"><a href="../activity_page.php">Home</a></li>
              <li><a href="form.php" >Create Poll</a></li>
...
<h1><b><?PHP echo "&nbsp;&nbsp;&nbsp; Welcome ". $username;?></b>
</h1>
<div class="bar"></div>
...
<h1>Create your poll</h1>       
		...
		if ( validate_op() && validate() && validate_title() && validate_des()== 1)
	{
		...
		var obj = {who : "<?php echo $username ?>", expiry_date : document.getElementById('poll_expiry_date').value,visibility : "public",
